...
Below the wordmark, the middle band of the Start screen shows **one of the child's own Pokémon**, big: artwork in a circular frame on the left, and beside it its name, its Dex number, and **"Welcome back!"**. The whole card is a button — tapping it re-rolls the pick, as does every return to the home screen.
